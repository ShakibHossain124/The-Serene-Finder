<?php
// Loads dashboard payload: current user info, bookings made, and jobs received.
session_start();
require_once '../db.php';
...
try {
    // Read the signed-in user's name and role for dashboard header widgets.
    ...
    // Providers also see bookings where they are the hired professional.
    $stmt_in = $pdo->prepare("
